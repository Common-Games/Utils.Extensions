...
1. Make an [Issue](https://github.com/common-games/utilities.extensions/issues/new)
...
```json
    {
        "dependencies": {
            "com.common-games.utilities.extensions": "https://github.com/YOUR_USER/utilities.extensions.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at https://github.com/Walter-Hulsebos/Utilities.Extensions/issues.
